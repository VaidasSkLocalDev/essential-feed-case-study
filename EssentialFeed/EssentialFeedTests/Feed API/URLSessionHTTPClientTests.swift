...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_performsGetRequstWithURL() {
        let url = anyURL()
    ...
    func test_getFromURL_failsOnAllIInvalidRepresentationCases() {
    ...
    func test_getFromURL_succeedsOnHTTPURLResponseWithData() {
        ...
        let receivedValues = resultValuesFor(data: data, response: response, error: nil) //URLProtocolStub.stub(data: data, response: response, error: nil)
